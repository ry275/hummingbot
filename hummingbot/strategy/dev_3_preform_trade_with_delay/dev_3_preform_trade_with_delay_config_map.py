...
def symbol_prompt():
    market = dev_3_preform_trade_with_delay_config_map.get("market").value
...
dev_3_preform_trade_with_delay_config_map = {
    "market":
    ...
    "order_price":
        ConfigVar(key="order_price",
                  ...
                  required_if=lambda: dev_3_preform_trade_with_delay_config_map.get("order_type").value == "limit",
                  type_str="float"),
}
